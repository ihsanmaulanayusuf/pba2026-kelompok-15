...
## 📌 Description
This project compares Machine Learning (PyCaret AutoML) and Deep Learning approaches for sentiment classification on Indonesian political YouTube comments.
...
- **Deep Learning (PyTorch LSTM)**: [https://huggingface.co/spaces/sannnnn31/sentiment-ml-pytorch](https://huggingface.co/spaces/sannnnn31/sentiment-ml-pytorch)
